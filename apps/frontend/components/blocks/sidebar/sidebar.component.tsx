...
export const SidebarBlockComponent = ({
  ...
  return (
    <aside className="bg-background-1 desktop:w-2/5 desktop:items-end flex flex-col">
      <div className="tablet:px-10 desktop:px-0 desktop:pt-[30px] tablet:gap-y-[3.125rem] desktop:w-[355px] desktop:mr-[85px] flex w-full flex-col gap-y-10 self-end px-5 pb-[1.875rem] pt-5">
