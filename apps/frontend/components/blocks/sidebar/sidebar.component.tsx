...
export const SidebarBlockComponent = ({
  ...
  return (
    <aside className="bg-background-1 desktop:w-2/5 desktop:items-end flex flex-col">
      <div className="tablet:px-10 desktop:px-0 desktop:pt-[1.875rem] tablet:gap-y-[3.125rem] desktop:w-[22.1875rem] desktop:ml-10 desktop:mr-[5.3125rem] flex w-full flex-col gap-y-10 self-end px-5 pb-[1.875rem] pt-5">
